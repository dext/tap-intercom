...
CONTENT_EXPORT_STREAMS = {
    ...
    "fin_step_reached": ContentExportStream,
    "goal_success": ContentExportStream,
    "hard_bounce": ContentExportStream,
    "open": ContentExportStream,
    "overview": ContentExportStream,
    "reaction": ContentExportStream,
    ...
    "series_exit": ContentExportStream,
    "tour_step_view": ContentExportStream,
    "tour_step_failure": ContentExportStream,
    "unsubscribe": ContentExportStream,
    "soft_bounce": ContentExportStream,
}
...
class TapIntercom(Tap):
    ...
    def discover_streams(self) -> list[streams.IntercomStream]:
        ...
        streams = [
            ...
            ContentExportStream(name="fin_step_reached", primary_keys=[], replication_key="involved_at", tap=self),
            ContentExportStream(name="goal_success", primary_keys=[], replication_key="goal_hit_at", tap=self),
            ContentExportStream(name="hard_bounce", primary_keys=[], replication_key="hard_bounced_at", tap=self),
            ...
            ContentExportStream(name="reaction", primary_keys=[], replication_key="reacted_at", tap=self),
            ...
            ContentExportStream(name="series_exit", primary_keys=[], replication_key="exited_at", tap=self),
            ContentExportStream(name="soft_bounce", primary_keys=[], replication_key="soft_bounced_at", tap=self),
            ContentExportStream(name="tour_step_failure", primary_keys=[], replication_key="failed_at", tap=self),
            ContentExportStream(name="tour_step_view", primary_keys=[], replication_key="viewed_at", tap=self),
            ContentExportStream(name="unsubscribe", primary_keys=[], replication_key="unsubscribed_at", tap=self),
